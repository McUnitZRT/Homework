...
console.log(`a = ${a}`); //Вывод на консоль значения a;
...
if(a > 10){
    if(a > 5){ 
        ...
        if(a < 3){
            if(1 > 4){ // Никогда не выполнится! По сути не нужен. Будет всегда выполняться блок с else.
                console.log(5);
            }
            else{ 
                if(a % 2 == 0){
...
switch(true){
    case a > 10 && a > 5:
        console.log((2 * a) + 1);
        break;
    case a > 10 && a <= 5 && a < 3 && 1 > 4: //Никогда не выполнится! По сути не нужен. Будет всегда выполняться следующие 2 case.
        console.log(5);
        break;
    case a > 10 && a <= 5 && a < 3 && 1 < 4 && a % 2 == 0: // 1 < 4 - как бы странно. Всегда true. Вообще по сути не нужен(т.к в тернарном операторе есть, я добавил)
        console.log(6); 
        break;
    ...
    case a <= 10 && (a * 2) > 5:
        console.log((2 * a) + 1);
        break;
    case a <= 10 && (a * 2) <= 5 && a < 3 && 1 > 4: //Никогда не выполнится! По сути не нужен. Будет всегда выполняться следующие 2 case.
        console.log(5);
        break;
